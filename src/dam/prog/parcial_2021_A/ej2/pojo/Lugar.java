package dam.prog.parcial_2021_A.ej2.pojo;
...
public class Lugar {
	...
	public Lugar(String ciudad, String pais, int prioridad, String motivo) throws Exception {
		this.ciudad = ciudad;
		this.pais = pais;
